...
y0 = Ny/2; % Centro del elipse en y
    ...
    % Leer la imagen
    Imagen = zeros(Nx);
    img = imread('C:\Users\qbo28\OneDrive\Documentos\Materias RyMA\Tesis Maestria\fotos\database\classification_2C\complete\a\01.png');%
    ...
    for i=1:length(z)
        ...
        input_args{:});% %kspaceFirstOrder2D(kgrid, medium, source, sensor,...%
       %input_args{:});
       %figure() 
...
reconstruction2 = iradon(N_time, Phi,"None");%"Ram-Lak");%
